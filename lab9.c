...
struct HashType
{
    struct Node *head; // Pointer to the first element in the linked list
};
...
int main(void)
{
    ...
    int recordSz = 0;
    int hashSz = 10; // Size of the hash table
    ...
    // Free memory
    // You'll need to free each node and the hash table itself
